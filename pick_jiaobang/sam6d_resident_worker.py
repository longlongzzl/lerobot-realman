...
def main() -> None:
    ...
    parser.add_argument("--template-cache-root", type=str, default="/home/zhangzhao/Desktop/lerobot/pick_jiaobang/sam6d_template_cache")
    parser.add_argument("--pem-feature-cache-root", type=str, default="/home/zhangzhao/Desktop/lerobot/pick_jiaobang/sam6d_pem_feature_cache")
